        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('cabVoucher.storeCabVoucherNumber', $cabVoucher->id) }}" method="post">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="cv_number" required >
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="submit" value="Issue" class="btn btn-sm btn-success" style="float: right;">
