        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('cabVoucher.sendReceiptCV', $cabVoucher->id) }}" method="post">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="cv_number" value="{{ $cabVoucher->cv_number }}" readonly >
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="submit" value="Send" class="btn btn-sm btn-success" style="float: right;">
